# PureAutoCodeQL V2 instructions
...
PureAutoCodeQL is not an Agent and not a general Agent Harness. It is a host-independent vulnerability-research capability layer used through Pi Agent, DeepSeek Harness, MCP, CLI and future thin integrations.
