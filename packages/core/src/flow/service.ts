...
export class FlowResearchService {
  ...
  private async writeCommitted(
    ...
    const flowArtifact = JSON.stringify(parseSchema(FlowRunArtifactSchema, {
      ...
      analyzer: extra.observation?.analyzer ?? { analyzer_id: "codeql", available: false, evidence_kind: "real_analyzer" },
      ...
      decision_policy_version: extra.decisionPolicyVersion ?? FLOW_DECISION_POLICY_VERSION,
